...
class DeteccionGestos:
    ...
    def contar_dedos(self, imagen, results, dibujo=True, display=True):
        ...
        if dibujo:
            ...
            cv2.putText(
                imagen_salida, str(sum(count.values())), (ancho // 2 - 150, 240),
                cv2.FONT_HERSHEY_SIMPLEX, 8.9,  (20, 255, 155), 10, 10
            )
